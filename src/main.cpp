...
int main(int argc, char **argv)
{
    ...
    std::cout << "// 3D Points KNN Search //" << std::endl;
    {
        const int nn = 2;
    ...
    std::cout << "// 3D Points Radius Search //" << std::endl;
    {
    ...
    std::cout << "// 2D Points KNN Search //" << std::endl;
    {
        const int nn = 2;
    ...
    std::cout << "// 2D Points Radius Search //" << std::endl;
    {
